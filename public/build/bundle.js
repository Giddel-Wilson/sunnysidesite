...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "transform svelte-14930gl");
    			add_location(h10, file$5, 6, 6, 115);
    			attr_dev(p0, "class", "svelte-14930gl");
    			add_location(p0, file$5, 7, 6, 169);
    			attr_dev(h30, "class", "svelte-14930gl");
    			add_location(h30, file$5, 13, 6, 387);
    			attr_dev(section0, "class", "gridInnerShell content svelte-14930gl");
    			add_location(section0, file$5, 5, 4, 67);
    			if (!src_url_equal(img0.src, img0_src_value = "./image-transform.jpg")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-14930gl");
    			add_location(img0, file$5, 16, 6, 481);
    			attr_dev(section1, "class", "gridInnerShell transformImg svelte-14930gl");
    			add_location(section1, file$5, 15, 4, 428);
    			attr_dev(div0, "class", "gridShell gsEX svelte-14930gl");
    			add_location(div0, file$5, 4, 2, 33);
    			if (!src_url_equal(img1.src, img1_src_value = "./image-stand-out.jpg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-14930gl");
    			add_location(img1, file$5, 21, 6, 622);
    			attr_dev(section2, "class", "gridInnerShell svelte-14930gl");
    			add_location(section2, file$5, 20, 4, 582);
    			attr_dev(h11, "class", "standOut svelte-14930gl");
    			add_location(h11, file$5, 24, 6, 734);
    			attr_dev(p1, "class", "svelte-14930gl");
    			add_location(p1, file$5, 25, 6, 799);
    			attr_dev(h31, "class", "svelte-14930gl");
    			add_location(h31, file$5, 31, 6, 1008);
    			attr_dev(section3, "class", "gridInnerShell content svelte-14930gl");
    			add_location(section3, file$5, 23, 4, 686);
    			attr_dev(div1, "class", "gridShell svelte-14930gl");
    			add_location(div1, file$5, 19, 2, 553);
    			...
    			attr_dev(img2, "class", "svelte-14930gl");
    			add_location(img2, file$5, 36, 6, 1141);
    			attr_dev(h12, "class", "svelte-14930gl");
    			add_location(h12, file$5, 38, 8, 1241);
    			attr_dev(p2, "class", "svelte-14930gl");
    			add_location(p2, file$5, 39, 8, 1274);
    			attr_dev(article0, "class", "cardContent svelte-14930gl");
    			add_location(article0, file$5, 37, 6, 1202);
    			attr_dev(section4, "class", "gridInnerShell card firstCard svelte-14930gl");
    			add_location(section4, file$5, 35, 4, 1086);
    			if (!src_url_equal(img3.src, img3_src_value = "./image-photography.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "orange");
    			attr_dev(img3, "class", "svelte-14930gl");
    			add_location(img3, file$5, 46, 6, 1541);
    			attr_dev(h13, "class", "svelte-14930gl");
    			add_location(h13, file$5, 48, 8, 1638);
    			attr_dev(p3, "class", "svelte-14930gl");
    			add_location(p3, file$5, 49, 8, 1668);
    			attr_dev(article1, "class", "cardContent svelte-14930gl");
    			add_location(article1, file$5, 47, 6, 1599);
    			attr_dev(section5, "class", "gridInnerShell card secondCard svelte-14930gl");
    			add_location(section5, file$5, 45, 4, 1485);
    			attr_dev(div2, "class", "gridShell svelte-14930gl");
    			add_location(div2, file$5, 34, 2, 1057);
    			attr_dev(main, "class", "svelte-14930gl");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 8, 4, 153);
    			...
    			add_location(img, file$4, 9, 4, 183);
    			attr_dev(section, "class", "creativeShell svelte-i0f16l");
    			add_location(section, file$4, 7, 2, 116);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-1yjei50");
    			add_location(img1, file$3, 21, 10, 619);
    			attr_dev(span1, "class", "svelte-1yjei50");
    			add_location(span1, file$3, 20, 8, 601);
    			attr_dev(div2, "class", "pfp svelte-1yjei50");
    			add_location(div2, file$3, 19, 6, 574);
    			attr_dev(p1, "class", "svelte-1yjei50");
    			add_location(p1, file$3, 24, 6, 697);
    			attr_dev(h31, "class", "name svelte-1yjei50");
    			add_location(h31, file$3, 29, 8, 894);
    			attr_dev(h51, "class", "position svelte-1yjei50");
    			add_location(h51, file$3, 30, 8, 935);
    			attr_dev(div3, "class", "nEtPos svelte-1yjei50");
    			add_location(div3, file$3, 28, 6, 864);
    			attr_dev(section1, "class", "innerShell svelte-1yjei50");
    			...
    			attr_dev(img2, "alt", "");
    			attr_dev(img2, "class", "svelte-1yjei50");
    			add_location(img2, file$3, 36, 10, 1101);
    			attr_dev(span2, "class", "svelte-1yjei50");
    			add_location(span2, file$3, 35, 8, 1083);
    			attr_dev(div4, "class", "pfp svelte-1yjei50");
    			add_location(div4, file$3, 34, 6, 1056);
    			attr_dev(p2, "class", "svelte-1yjei50");
    			add_location(p2, file$3, 39, 6, 1179);
    			attr_dev(h32, "class", "name svelte-1yjei50");
    			add_location(h32, file$3, 44, 8, 1354);
    			attr_dev(h52, "class", "position svelte-1yjei50");
    			add_location(h52, file$3, 45, 8, 1395);
    			attr_dev(div5, "class", "nEtPos svelte-1yjei50");
    			add_location(div5, file$3, 43, 6, 1324);
    			attr_dev(section2, "class", "innerShell svelte-1yjei50");
    			add_location(section2, file$3, 33, 4, 1020);
    			attr_dev(div6, "class", "testimonialShell svelte-1yjei50");
    			add_location(div6, file$3, 4, 2, 63);
    			attr_dev(main, "class", "svelte-1yjei50");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Hero, Testimonial, FlexBox, Footer });
    	return [];
    }
