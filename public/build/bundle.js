    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "sunnyside");
    			attr_dev(img, "class", "logo");
    			add_location(img, file$6, 4, 8, 66);
    			attr_dev(div0, "class", "logoShell");
    			add_location(div0, file$6, 3, 4, 33);
    			attr_dev(a0, "href", "#");
    			attr_dev(a0, "class", "svelte-ry8st4");
    			add_location(a0, file$6, 7, 8, 168);
    			attr_dev(a1, "href", "#");
    			attr_dev(a1, "class", "svelte-ry8st4");
    			add_location(a1, file$6, 8, 8, 199);
    			attr_dev(a2, "href", "#");
    			attr_dev(a2, "class", "svelte-ry8st4");
    			add_location(a2, file$6, 9, 8, 233);
    			attr_dev(a3, "href", "#");
    			attr_dev(a3, "class", "svelte-ry8st4");
    			add_location(a3, file$6, 10, 8, 267);
    			attr_dev(div1, "class", "linkShell svelte-ry8st4");
    			add_location(div1, file$6, 6, 4, 135);
    			attr_dev(main, "class", "svelte-ry8st4");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			img = element("img");
    			attr_dev(h1, "class", "svelte-5iiv1p");
    			...
    			attr_dev(img, "class", "svelte-5iiv1p");
    			add_location(img, file$5, 8, 4, 146);
    			attr_dev(section, "class", "creativeShell svelte-5iiv1p");
    			add_location(section, file$5, 6, 2, 79);
    			attr_dev(main, "class", "svelte-5iiv1p");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "transform svelte-l7wgws");
    			add_location(h10, file$4, 6, 6, 110);
    			attr_dev(p0, "class", "svelte-l7wgws");
    			add_location(p0, file$4, 7, 6, 164);
    			attr_dev(h30, "class", "svelte-l7wgws");
    			add_location(h30, file$4, 13, 6, 382);
    			attr_dev(section0, "class", "gridInnerShell content svelte-l7wgws");
    			...
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-l7wgws");
    			add_location(img0, file$4, 16, 6, 463);
    			attr_dev(section1, "class", "gridInnerShell svelte-l7wgws");
    			add_location(section1, file$4, 15, 4, 423);
    			attr_dev(div0, "class", "gridShell svelte-l7wgws");
    			...
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-l7wgws");
    			add_location(img1, file$4, 21, 6, 604);
    			attr_dev(section2, "class", "gridInnerShell svelte-l7wgws");
    			add_location(section2, file$4, 20, 4, 564);
    			attr_dev(h11, "class", "standOut svelte-l7wgws");
    			add_location(h11, file$4, 24, 6, 716);
    			attr_dev(p1, "class", "svelte-l7wgws");
    			add_location(p1, file$4, 25, 6, 781);
    			attr_dev(h31, "class", "svelte-l7wgws");
    			add_location(h31, file$4, 31, 6, 990);
    			attr_dev(section3, "class", "gridInnerShell content svelte-l7wgws");
    			add_location(section3, file$4, 23, 4, 668);
    			attr_dev(div1, "class", "gridShell svelte-l7wgws");
    			...
    			attr_dev(img2, "class", "svelte-l7wgws");
    			add_location(img2, file$4, 36, 6, 1123);
    			attr_dev(h12, "class", "svelte-l7wgws");
    			add_location(h12, file$4, 38, 8, 1223);
    			attr_dev(p2, "class", "svelte-l7wgws");
    			add_location(p2, file$4, 39, 8, 1256);
    			attr_dev(article0, "class", "cardContent svelte-l7wgws");
    			add_location(article0, file$4, 37, 6, 1184);
    			attr_dev(section4, "class", "gridInnerShell card firstCard svelte-l7wgws");
    			...
    			attr_dev(img3, "class", "svelte-l7wgws");
    			add_location(img3, file$4, 46, 6, 1523);
    			attr_dev(h13, "class", "svelte-l7wgws");
    			add_location(h13, file$4, 48, 8, 1620);
    			attr_dev(p3, "class", "svelte-l7wgws");
    			add_location(p3, file$4, 49, 8, 1650);
    			attr_dev(article1, "class", "cardContent svelte-l7wgws");
    			add_location(article1, file$4, 47, 6, 1581);
    			attr_dev(section5, "class", "gridInnerShell card secondCard svelte-l7wgws");
    			add_location(section5, file$4, 45, 4, 1467);
    			attr_dev(div2, "class", "gridShell svelte-l7wgws");
    			add_location(div2, file$4, 34, 2, 1039);
    			attr_dev(main, "class", "svelte-l7wgws");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-qszupc");
    			add_location(img1, file$3, 21, 10, 619);
    			attr_dev(span1, "class", "svelte-qszupc");
    			add_location(span1, file$3, 20, 8, 601);
    			attr_dev(div2, "class", "pfp svelte-qszupc");
    			add_location(div2, file$3, 19, 6, 574);
    			attr_dev(p1, "class", "svelte-qszupc");
    			add_location(p1, file$3, 24, 6, 697);
    			attr_dev(h31, "class", "name svelte-qszupc");
    			add_location(h31, file$3, 29, 8, 894);
    			attr_dev(h51, "class", "position svelte-qszupc");
    			add_location(h51, file$3, 30, 8, 935);
    			attr_dev(div3, "class", "nEtPos svelte-qszupc");
    			add_location(div3, file$3, 28, 6, 864);
    			attr_dev(section1, "class", "innerShell svelte-qszupc");
    			...
    			attr_dev(img2, "alt", "");
    			attr_dev(img2, "class", "svelte-qszupc");
    			add_location(img2, file$3, 36, 10, 1101);
    			attr_dev(span2, "class", "svelte-qszupc");
    			add_location(span2, file$3, 35, 8, 1083);
    			attr_dev(div4, "class", "pfp svelte-qszupc");
    			add_location(div4, file$3, 34, 6, 1056);
    			attr_dev(p2, "class", "svelte-qszupc");
    			add_location(p2, file$3, 39, 6, 1179);
    			attr_dev(h32, "class", "name svelte-qszupc");
    			add_location(h32, file$3, 44, 8, 1354);
    			attr_dev(h52, "class", "position svelte-qszupc");
    			add_location(h52, file$3, 45, 8, 1395);
    			attr_dev(div5, "class", "nEtPos svelte-qszupc");
    			add_location(div5, file$3, 43, 6, 1324);
    			attr_dev(section2, "class", "innerShell svelte-qszupc");
    			add_location(section2, file$3, 33, 4, 1020);
    			attr_dev(div6, "class", "testimonialShell svelte-qszupc");
    			add_location(div6, file$3, 4, 2, 63);
    			attr_dev(main, "class", "svelte-qszupc");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-1vs6nrx");
    			add_location(img0, file$1, 4, 4, 83);
    			attr_dev(a0, "href", "#");
    			attr_dev(a0, "class", "svelte-1vs6nrx");
    			add_location(a0, file$1, 6, 6, 151);
    			attr_dev(a1, "href", "#");
    			attr_dev(a1, "class", "svelte-1vs6nrx");
    			add_location(a1, file$1, 7, 6, 180);
    			attr_dev(a2, "href", "#");
    			attr_dev(a2, "class", "svelte-1vs6nrx");
    			add_location(a2, file$1, 8, 6, 212);
    			attr_dev(div0, "class", "linkShell svelte-1vs6nrx");
    			add_location(div0, file$1, 5, 4, 120);
    			attr_dev(div1, "class", "innerShell iS1 svelte-1vs6nrx");
    			...
    			attr_dev(img1, "class", "svelte-1vs6nrx");
    			...
    			attr_dev(img2, "class", "svelte-1vs6nrx");
    			...
    			attr_dev(img3, "class", "svelte-1vs6nrx");
    			...
    			attr_dev(img4, "class", "svelte-1vs6nrx");
    			add_location(img4, file$1, 15, 4, 473);
    			attr_dev(div2, "class", "innerShell iS2 svelte-1vs6nrx");
    			add_location(div2, file$1, 11, 2, 262);
    			attr_dev(main, "class", "mainShell svelte-1vs6nrx");
