    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "transform svelte-1fd3ol9");
    			add_location(h10, file$4, 6, 6, 115);
    			attr_dev(p0, "class", "svelte-1fd3ol9");
    			add_location(p0, file$4, 7, 6, 169);
    			attr_dev(h30, "class", "svelte-1fd3ol9");
    			add_location(h30, file$4, 13, 6, 387);
    			attr_dev(section0, "class", "gridInnerShell content svelte-1fd3ol9");
    			...
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-1fd3ol9");
    			add_location(img0, file$4, 16, 6, 468);
    			attr_dev(section1, "class", "gridInnerShell svelte-1fd3ol9");
    			add_location(section1, file$4, 15, 4, 428);
    			attr_dev(div0, "class", "gridShell gsEX svelte-1fd3ol9");
    			...
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-1fd3ol9");
    			add_location(img1, file$4, 21, 6, 609);
    			attr_dev(section2, "class", "gridInnerShell svelte-1fd3ol9");
    			add_location(section2, file$4, 20, 4, 569);
    			attr_dev(h11, "class", "standOut svelte-1fd3ol9");
    			add_location(h11, file$4, 24, 6, 721);
    			attr_dev(p1, "class", "svelte-1fd3ol9");
    			add_location(p1, file$4, 25, 6, 786);
    			attr_dev(h31, "class", "svelte-1fd3ol9");
    			add_location(h31, file$4, 31, 6, 995);
    			attr_dev(section3, "class", "gridInnerShell content svelte-1fd3ol9");
    			add_location(section3, file$4, 23, 4, 673);
    			attr_dev(div1, "class", "gridShell svelte-1fd3ol9");
    			add_location(div1, file$4, 19, 2, 540);
    			...
    			attr_dev(img2, "class", "svelte-1fd3ol9");
    			add_location(img2, file$4, 36, 6, 1128);
    			attr_dev(h12, "class", "svelte-1fd3ol9");
    			add_location(h12, file$4, 38, 8, 1228);
    			attr_dev(p2, "class", "svelte-1fd3ol9");
    			add_location(p2, file$4, 39, 8, 1261);
    			attr_dev(article0, "class", "cardContent svelte-1fd3ol9");
    			add_location(article0, file$4, 37, 6, 1189);
    			attr_dev(section4, "class", "gridInnerShell card firstCard svelte-1fd3ol9");
    			add_location(section4, file$4, 35, 4, 1073);
    			if (!src_url_equal(img3.src, img3_src_value = "./image-photography.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "orange");
    			attr_dev(img3, "class", "svelte-1fd3ol9");
    			add_location(img3, file$4, 46, 6, 1528);
    			attr_dev(h13, "class", "svelte-1fd3ol9");
    			add_location(h13, file$4, 48, 8, 1625);
    			attr_dev(p3, "class", "svelte-1fd3ol9");
    			add_location(p3, file$4, 49, 8, 1655);
    			attr_dev(article1, "class", "cardContent svelte-1fd3ol9");
    			add_location(article1, file$4, 47, 6, 1586);
    			attr_dev(section5, "class", "gridInnerShell card secondCard svelte-1fd3ol9");
    			add_location(section5, file$4, 45, 4, 1472);
    			attr_dev(div2, "class", "gridShell svelte-1fd3ol9");
    			add_location(div2, file$4, 34, 2, 1044);
    			attr_dev(main, "class", "svelte-1fd3ol9");
